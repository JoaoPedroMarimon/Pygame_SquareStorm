...
"""
Módulo para a tela de compra e melhoria de armas.
"""
...
def tela_armas(tela, relogio, gradiente_loja):
    """
    Exibe a tela de compra e melhoria de armas.
    ...
    # Loop principal da tela de armas
    rodando = True
    while rodando:
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                # Tecla ESC, Backspace para voltar à loja
        ...
        # Desenhar título
        desenhar_texto(tela, "ARSENAL", 70, BRANCO, LARGURA // 2, 80)
        ...
        # Configurações dos painéis de armas
        ...
        # Título do item
        desenhar_texto(tela, "Espingarda", 32, (150, 150, 255), 
        ...
        # Aqui você pode adicionar mais armas para o jogador
        # ==== EXEMPLO: NOVA ARMA ====
        # (código para uma nova arma seria colocado aqui)
